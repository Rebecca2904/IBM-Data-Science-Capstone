# Installing modules, importing data, im Terminal ausführen:
...
#print(spacex_df.groupby(['Launch Site']).first())
#print(spacex_df['Launch Site'].groupby(['Launch Site']))
#print(spacex_df.groupby(['Launch Site']).first()['Launch Site'][0])
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title='Successful vs. failed landing of site {}'.format(entered_site))
        return fig
...
def get_scatter_plot(entered_site,payload):
    ...
    if entered_site == 'ALL':
        ...
        title='Success vs. Payload of site {}'.format(entered_site))
        return fig
